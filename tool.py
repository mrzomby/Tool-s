...
def cobra():
    ...
    y = (g + "-" * 50)
    yopie = (y + p + "\nAuthor :" + g + " Mr.ZOMBYn\n" + r + p + "Github :" + g + " https://github.com/mrzomby\n" + r + p + "Contact wa :" + g + " +6285608482684\n" + y + p + "\nLogin fb your account\n" + r);
...
def main():
    ...
    print m + "[" + p + "02" + m + "]" + g + ".DDOS" + "                         " + m + "[" + p + "12" + m + "]" + g + ".Dios Sqli Creator" + r;
    ...
    print m + "[" + p + "05" + m + "]" + g + ".Pengenalan member Zx" + "         " + m + "[" + p + "15" + m + "]" + g + ".compile marshal file python" + r;
    print m + "[" + p + "06" + m + "]" + g + ".Email Scraping" + "               " + m + "[" + p + "16" + m + "]" + g + ".Deface Creator" + r
    print m + "[" + p + "07" + m + "]" + g + ".IMDB Rating" + "                  " + m + "[" + p + "17" + m + "]" + g + ".Subtool & IGET" + r
    ...
    if choice == '17' or choice == 'tujuh belas':
			...
			if wibu == "1" or wibu == "01":
				one(),pilih()
			elif wibu == "2" or wibu == "02":
				two(),pilih()
			elif wibu == "3" or wibu == "03":
				tiga(),pilih()
			elif wibu == "4" or wibu == "04":
				four(),pilih()
			elif wibu == "5" or wibu == "05":
				five(),pilih()
			elif wibu == "6" or wibu == "06":
				six(),pilih()
			elif wibu == "7" or wibu == "07":
				seven(),pilih()
			elif wibu == "8" or wibu == "08":
				lapan(),pilih()
			elif wibu == "9" or wibu == "09":
				nine(),pilih()
			elif wibu == "10":
				ten(),pilih()
			elif wibu == "11":
